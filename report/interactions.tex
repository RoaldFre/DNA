...
\todo{CHECK THAT WE MENTION IT :P} \cmt{changed: excluded volume (mentioned); base pairing constants (not changed for temperature sensitive stuff; but using the Knotts values when only simulating hairpin formation power law}.
...
$k_2$ & $100\varepsilon$ per $\Angstrom^2$ &
	$\varepsilon_\text{AT}$ & 3.90\,kcal/mol\\
$k_\theta$ & $400\varepsilon$ per (radian)$^2$ &
	$\varepsilon_\text{GC}$ & 4.37\,kcal/mol\\
