...
for dt in 10 20
do
	octave -q --eval "toNativeData2D('/home/other/roald/clusterdata/${gamma}_${N}_${dt}/*/*strand*', 'data/strand_dt${dt}_wait50_time1000_N${N}_g${gamma}');" &
	octave -q --eval "toNativeData2D('/home/other/roald/clusterdata/${gamma}_${N}_${dt}/*/*particle*', 'data/particle_dt${dt}_wait50_time1000_N${N}_g${gamma}');" &
	wait
done
