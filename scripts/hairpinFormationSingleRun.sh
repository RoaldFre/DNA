...
$main -t $timestep -E $zippingTemp -T $zippingTemp -I $interval -P $time -W $wait -s $seq -D $outputFile -H $allowUnbounded -M $allowBounded -O $zippingTemp -Q $unzippingTemp -U $zippedRelaxation -X f
