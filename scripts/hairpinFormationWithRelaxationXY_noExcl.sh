...
main=hairpin_NO_EXCL # Should be in current working dir, or in $PATH
timestep=15
interval=100
...
destinationDir="$destinationDirRoot/$fullSequence/relaxT${relaxTemp}_zipT${zippingTemp}_unzipT${unzippingTemp}_allowUnb${allowedUnboundedFraction}_zippedRel${zippedRelaxation}_NXY${NXY}/dt${timestep}/N${N}"
